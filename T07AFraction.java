...
public class T07AFraction {
  ...
  /* Method untuk menambahkan nilai pecahan 1 dan pecahan 2 */
  ...
  /* Method untuk mengeluarkan hasil pecahan ke terminal */
  static void printFraction(int e, int d) {
    System.out.println(e + " / " + d); 
  }

  /* Method untuk mencari nilai fpb dari pembilang dan penyebut pada pecahan */
